          ...
          <el-row type="flex" align="bottom" justify="center" class="position_img">
            <div id="position_canvas">
                  ...
                  <div>
                    ...
                    <div class="adrList">
                                            <span :key="ix" :style="{'backgroundColor':setting.color}"
                                                  v-for="(setting,ix) in settingList.positionList">{{
                                                setting.name
                                              }}</span>
                    </div>
                  </div>
                  <div>
                    <p class="details">库房面积：{{ activePoint.area }}<span class="unit_m">m</span></p>
                    <p class="details">
                      状态：{{ activePointOther.humidityState }}/湿度{{ activePointOther.humidityQujian }}</p>
                    <p class="details">
                      氧气二氧化碳：{{ activePointOther.oxygen }}%，{{ activePointOther.co2 }}%</p>
                    <p class="details">
              ...
              <div class="garden_img">
                ...
                <img :src="'https://www.caikeai.com/api/file/upload/'+settingList.bgUrl" alt="">
              </div>
            </div>
          </el-row>
        ...
        <el-col class="visualizationBox_c garden_vh">
          <el-row type="flex" align="bottom" justify="center" class="part_img">
            <div class="part_img_box">
              <img :src="'https://www.caikeai.com/api/file/upload/'+activePoint.partImg" alt="">
            </div>
          </el-row>
              ...
              <el-row type="flex" align="middle" justify="center" class="circle_chart garden_vh">
                <div class="circle_chart_box circle_chart_box1">
                  <div>
                    ...
                    <span><span>{{ activePointOther.oxygen }}</span>
              ...
              <el-row type="flex" align="middle" justify="center" class="circle_chart garden_vh">
                <div class="circle_chart_box circle_chart_box2">
                  <div>
                    ...
                    <span>{{ activePointOther.humi }}</span>
                  </div>
                  <p>湿度</p>
                </div>
              </el-row>
              <el-row type="flex" align="middle" justify="center" class="circle_chart garden_vh">
                <div class="circle_chart_box circle_chart_box3">
                  <div>
                    ...
                    <span>{{ activePointOther.temp }}</span>
              ...
              <el-row type="flex" align="middle" justify="center" class="circle_chart garden_vh">
                <div class="circle_chart_box circle_chart_box4">
                  <div>
                    ...
                    <span>
                                            <span>{{ activePointOther.co2 }}</span>
                                            <span class="unit">%</span>
                                        </span>
                  </div>
                  <p>二氧化碳含量</p>
...
export default {
  ...
  methods: {
    ...
    loadPointOtherMsg(sn) {
      this.ajaxGet({
        url: '/api/equipment/mqtt/getFreezerAllNowByClientId?clientId=' + sn,
        headers: {
          Access_User_Token: this.userInfo.token
        },
        success: function (res) {
          ...
          if (this.activePointOther.humi || this.activePointOther.humi === 0) {
            if (this.activePointOther.humi < this.activePoint.humidityMin) {
              this.activePointOther.humidityQujian = '偏低';
            } else if (this.activePointOther.humi > this.activePoint.humidityMax) {
          ...
          this.radarChart.setOption({
            series: [{
              data: [
                {
                  value: [this.activePointOther.temp, this.activePointOther.soilTemp, this.activePointOther.humi,
                    this.activePointOther.ethylene, this.activePointOther.oxygen, this.activePointOther.light]
                }
              ]
            }]
          });
    ...
    loadPointLineChart() {
      ...
      this.ajaxGet({
        url: '/api/equipment/mqtt/getFreezerAllByClientIdWeb?clientId=' + this.activePoint.device
